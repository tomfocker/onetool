...
import {
  ...
  Globe, Clock, Settings, Image, Video, Clipboard, Palette, QrCode, Radar, Inbox, Languages, Camera, ShieldCheck, TerminalSquare, Star, Code, CloudDownload, PanelTop, Table2, CalendarDays, FileText
} from 'lucide-react'
