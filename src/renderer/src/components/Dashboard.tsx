...
import {
  ...
  Inbox, Radar, Search, Sun, Moon, ShieldCheck, TerminalSquare, PanelTop
} from 'lucide-react'
...
const iconMap: Record<string, any> = {
  Package, Terminal, Mic, MousePointer, Image, Globe, Clock, Settings, Video, Clipboard, Palette, QrCode, Languages, Camera, Inbox, Radar, ShieldCheck, TerminalSquare, PanelTop
}
