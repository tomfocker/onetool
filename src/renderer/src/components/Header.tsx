...
export const Header: React.FC = () => {
  ...
  return (
    <header className='h-12 bg-white/60 dark:bg-[#2a2d35]/80 backdrop-blur-xl border-b border-white/20 dark:border-white/10 fixed top-8 left-64 right-0 flex items-center px-6 z-20 shadow-soft-sm'>
